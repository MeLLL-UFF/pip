...
namespace MLAgents
{
    ...
    public abstract class Agent : MonoBehaviour
    {
        ...
        bool terminate;
        // this function was created to force terminate state inside override CollectObservations() function
        ...
        void OnEnableHelper(Academy academy)
        {
            ...
            //academy.AgentRewards += AgentAfterStep;
            ...
            {
                /* Commented because it is generating big log file.
                 * 
                 * Debug.Log(
                    string.Format(
        ...
        /*public virtual void AgentRewards()
        {
        ...
        /*void AgentAfterStep()
        {
            if ((wasRequestedAction) && (brain != null))
            {
                wasRequestedAction = false;
                AgentRewards();
            }
